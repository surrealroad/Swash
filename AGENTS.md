...
- **Run Tests**: Execute all relevant unit, integration, and build tests locally to validate that changes do not break existing functionality or introduce regressions before committing.

## 2. Automatic Commits and Pushes
